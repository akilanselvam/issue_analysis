...
import com.app.IssueAnalysis.dto.*;
...
import com.app.IssueAnalysis.mapper.*;
import com.app.IssueAnalysis.model.*;
import com.app.IssueAnalysis.repository.*;
...
public class CommentService {
    ...
    public boolean containsSwearWords(String comment) {
        if (comment.contains("shit")) {
            throw new IssueAnalysisException("Comments contains unacceptable language");
        }
        return false;
    }
